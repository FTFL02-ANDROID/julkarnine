...
public class MadicationDataSource {
	...
	List<Medication> vaccinationList = new ArrayList<Medication>();
	...
	public boolean deleteData(int eVaccineId) {
		this.open();
		try {
			iCareDatabase.delete(ICareSQLiteHelper.TABLE_MEDICATION,
					ICareSQLiteHelper.COL_MEDICATION_ID + "=" + eVaccineId, null);
		} catch (Exception ex) {
		...
		if (mCursor != null) {
			if (mCursor.moveToFirst()) {
				...
				do {
					...
					vaccinationList.add(new Medication(id, name,
