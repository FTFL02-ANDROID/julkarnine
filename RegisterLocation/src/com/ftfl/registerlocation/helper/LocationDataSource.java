...
public class LocationDataSource {
	...
	LocationModel mSingleHospital;
	List<LocationModel> mHospitals = new ArrayList<LocationModel>();
	...
	public boolean insert(LocationModel hospital) {
	...
	public boolean updateData(long eActivityId, LocationModel hospital) {
		this.open();
	 ...
	 */
	public LocationModel singleHospital(String id) {
		this.open();
		...
		if (mCursor != null) {
			if (mCursor.moveToFirst()) {
				...
				do {
					...
					mSingleHospital = new LocationModel(mActivityId, mActivityName,
	...
	public LocationModel updateActivityData(long eActivityId) {
		this.open();
		LocationModel UpdateActivity;
		...
		mUpdateCursor.close();
		UpdateActivity = new LocationModel(mActivityId, mActivityName,
	 ...
	 * using cursor for display data from database.
	 */
	public List<LocationModel> allHospitals() {
		this.open();
		...
		if (mCursor != null) {
			if (mCursor.moveToFirst()) {
				...
				do {
					...
					mHospitals.add(new LocationModel(mActivityId, mActivityName,
							mActivityAddress, mActivityLatitude,
							mActivityLongitude, mActivityDescription, mImage));
