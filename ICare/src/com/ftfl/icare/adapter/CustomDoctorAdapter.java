...
public class CustomDoctorAdapter extends ArrayAdapter<ICareProfile> {
	...
	public CustomDoctorAdapter(Activity context, List<ICareProfile> eProfile) {
		super(context, R.layout.fragment_layout_view_doctor_list_item,
				eProfile);
		this.data = eProfile;
