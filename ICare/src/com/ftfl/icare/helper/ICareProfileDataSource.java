...
public class ICareProfileDataSource {
	...
	List<String> iCareProfilesId = new ArrayList<String>();
	...
	public boolean insert(ICareProfile iprofile) {
		...
		long check = iCareDatabase.insert(ICareSQLiteHelper.TABLE_I_CARE_PROFILE,
				null, cv);
		iCareDatabase.close();
	...
	public boolean updateData(int profileId, ICareProfile iprofile) {
		...
		int check = iCareDatabase.update(ICareSQLiteHelper.TABLE_I_CARE_PROFILE,
	...
	public boolean deleteData(int profileId) {
		this.open();
		try {
			iCareDatabase.delete(ICareSQLiteHelper.TABLE_I_CARE_PROFILE,
	...
	public List<ICareProfile> iCareProfilesList() {
		...
		Cursor mCursor = iCareDatabase.query(ICareSQLiteHelper.TABLE_I_CARE_PROFILE,
		...
		if (mCursor != null) {
			if (mCursor.moveToFirst()) {
				...
				do {
					...
					iCareProfilesList.add(new ICareProfile(id, name, gender,
